...
const Userlist = () => {
  ...
  return (
    <div className="minheight d-flex justify-content-center mt-5" style={{ width: "100%", minHeight: "100vh" }}>
      ...
      <h3 style={{textAlign:'center',color:'#006666',fontWeight:'600',textDecoration:'underline'}}>Contact Management</h3>

            </div>
            <div className="col-lg-3 d-flex justify-content-between" style={{width:'100%'}}>
              <p className="m-0 customfont" style={{fontSize:'24px'}}>All Users</p>
